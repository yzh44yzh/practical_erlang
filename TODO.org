...
** TODO 10. gen_server, продолжение
   как пользоваться стандартным gen_server
...
** TODO 9. gen_server
   ну нужно делать упражнение на базе написанного кастомного gen_server
   - Можно вынести loop в generic часть и дергать оттуда handle_call. Но это фиг протестишь.
   - Можно добавить сохранение и получение истории всех входящих и исходящих сообщений.
     Это легко протестить, но нужно придумать аргументацию, зачем это.
   - Можно просто расширить публичное АПИ и обработку в loop. Но это как-то банально и не педагогично.
   надо думать ...
