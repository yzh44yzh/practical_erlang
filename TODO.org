...
новая реализация map reduce, отшлифовать, поправить найминг, оставить вместо старой
...
новая реализация main, отшлифовать, поправить найминг, оставить вместо старой
