* TODO все остальные темы убрать из этого курса
  + завести новый курс erlang_for_web
  + перенести туда лишнее из
    + TODO
    + notes
    + README
  + перенести туда лишние темы
  - перенести туда полезные материалы erlang-school (кажись, только dchat)
  - запушить в закрытый репозиторий на bitbucket
  - удалить erlang-school репозиторий
